...
class HarmonyPrefsBulkCommitActivity : AppCompatActivity() {
    ...
    private fun runTest() {
        testRunDeferred = lifecycleScope.async(Dispatchers.Default) {
            ...
            activityVanillaPrefs = EncryptedSharedPreferences.create(PREFS_NAME, masterKeyAlias, this@HarmonyPrefsBulkCommitActivity, EncryptedSharedPreferences.PrefKeyEncryptionScheme.AES256_SIV, EncryptedSharedPreferences.PrefValueEncryptionScheme.AES256_GCM)
            ...
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Vanilla - Max to commit one item: ${vanillaSingleCommitTimeSpent.maxOrNull()} ms")
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Vanilla - Min to commit one item: ${vanillaSingleCommitTimeSpent.minOrNull()} ms")
            ...
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Vanilla - Max commit test time: ${vanillaTotalCommitTimeSpent.maxOrNull()} ms")
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Vanilla - Min commit test time: ${vanillaTotalCommitTimeSpent.minOrNull()} ms")
            ...
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Vanilla - Max to read one item: ${vanillaSingleReadTimeSpent.maxOrNull()} ms")
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Vanilla - Min to read one item: ${vanillaSingleReadTimeSpent.minOrNull()} ms")
            ...
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Vanilla - Max read test time: ${vanillaTotalReadTimeSpent.maxOrNull()} ms")
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Vanilla - Min read test time: ${vanillaTotalReadTimeSpent.minOrNull()} ms")
            ...
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Harmony - Max to commit one item: ${harmonySingleCommitTimeSpent.maxOrNull()} ms")
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Harmony - Min to commit one item: ${harmonySingleCommitTimeSpent.minOrNull()} ms")
            ...
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Harmony - Max commit test time: ${harmonyTotalCommitTimeSpent.maxOrNull()} ms")
            Log.i("Trial", "${this@HarmonyPrefsBulkCommitActivity::class.java.simpleName}: Harmony - Min commit test time: ${harmonyTotalCommitTimeSpent.minOrNull()} ms")
