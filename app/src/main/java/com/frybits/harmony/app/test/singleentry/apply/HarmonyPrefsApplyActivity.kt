...
class HarmonyPrefsApplyActivity : AppCompatActivity() {
    ...
    private fun runTest() {
        testRunDeferred = lifecycleScope.async(Dispatchers.Default) {
            ...
            activityVanillaPrefs = EncryptedSharedPreferences.create(PREFS_NAME, masterKeyAlias, this@HarmonyPrefsApplyActivity, EncryptedSharedPreferences.PrefKeyEncryptionScheme.AES256_SIV, EncryptedSharedPreferences.PrefValueEncryptionScheme.AES256_GCM)
